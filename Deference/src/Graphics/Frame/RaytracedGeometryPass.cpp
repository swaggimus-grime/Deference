...
{	
	...
	AddOutTarget(g, "Albedo", DXGI_FORMAT_R32G32B32A32_FLOAT);
	AddOutTarget(g, "Specular", DXGI_FORMAT_R32G32B32A32_FLOAT);
	AddOutTarget(g, "Emissive", DXGI_FORMAT_R32G32B32A32_FLOAT);
